 ...
 */
public class BMFont {
    private static final Logger logger = Logger.getLogger(BMFont.class.getName());
    ...
    private void procesKerningNode(final Node node) {
        ...
        final int amount = getIntAttrib("amount", attribs);
		 HashMap<Integer, Integer> amtHash = _kernMap.get(first);
		 if (amtHash == null) {
     ...
     */
    public static final class RenderStateSetter {
