local particles = CreateParticlePrototype( "jetcore", "/textures/particles/dot.png", 37)

particles:setEmissionDirection(0, 1, 0)
particles:setInitialVelocity(-0.001290)
particles:setStartSize(0.02110)
particles:setEndSize(0.13)
particles:setMinimumLifetime(60)
particles:setMaximumLifetime(170)
particles:setEmitter(CreatePointEmitter())

particles:setStartSpin(-0.2)
particles:setEndSpin(0.2)

particles:setStartColor(0.94, 0.3, 0.49, 0.993)
particles:setEndColor(0.99, 0.55, 0.0, 0.02)
particles:setMaximumAngle(07)
