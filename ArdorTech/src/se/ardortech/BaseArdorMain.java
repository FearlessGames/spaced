...
public class BaseArdorMain implements Main {
	...
	public void run() {
		...
		frameHandler.init();
		SystemInfo systemInfo = new SystemInfo(LoggerFactory.getLogger("SystemInfo"));
		systemInfo.logHardwareData();
		systemInfo.logOsData();
		systemInfo.logJvmData();
		systemInfo.logGlCapabilities();
		mainLoop();
	}
