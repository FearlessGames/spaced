local particles = CreateParticlePrototype("lazor_blast_core", "/textures/particles/energybullet.png", 15)

particles:setEmissionDirection(0, 1, 0)
particles:setInitialVelocity(0.0009)
particles:setStartSize(0.6)
particles:setEndSize(0.2)
particles:setMinimumLifetime(150)
particles:setMaximumLifetime(150)
particles:setStartColor(1, 0.0, 0.4, 1)
