...
import se.spaced.server.services.webservices.external.BroadcastWebServiceImpl;
import se.spaced.server.services.webservices.external.EntityWebService;
import se.spaced.server.services.webservices.external.EntityWebServiceImpl;
import se.spaced.server.services.webservices.external.KillStatisticsWebService;
import se.spaced.server.services.webservices.external.KillStatisticsWebServiceImpl;
import se.spaced.server.services.webservices.external.SpellStatisticsWebService;
import se.spaced.server.services.webservices.external.SpellStatisticsWebServiceImpl;
